...
//            }
//
//            // If no match found, add to PendingList
//            if (!matchFound) {
//                for (Document applicantDoc : newApplicantPassportList) {
...
//            oos = new ObjectOutputStream(fos);
//        }
//        // write only the verified applicant and add to in-memory list
//        oos.writeObject(applicantDoc);
...
//
//public class VisaDecisionController
//{
//    @javafx.fxml.FXML
...
//
//
//        filterComboBox2.getItems().addAll("Verified Applications", "Pending Applications");
//
...
//
//
//    ArrayList<Document>FinalVerifiedListForTable = new ArrayList<>();
//    ArrayList<Document>FinalPendingListForTable = new ArrayList<>();
//
//    @javafx.fxml.FXML
//    public void loadFInalVerifiedListOnAction(ActionEvent actionEvent) {
//        FileInputStream fis = null;
//        ObjectInputStream ois = null;
//        try{
//            File f = new File("VerifiedList.bin");
...
//
//    @javafx.fxml.FXML
//    public void refreshTable1OnAction(ActionEvent actionEvent) {
//        documentTableView1.getItems().clear();
//        showAlert1("Refreshed", "All lists have been cleared.");
//    }
//
//    @javafx.fxml.FXML
//    public void verifiedAndPendingListButtonOnAction(ActionEvent actionEvent) {
//        documentTableView.getItems().clear();
//        inputAppIdForVerifyTextField.clear();
//        documentTableView.getItems().addAll(VerifiedListForTable);
//        documentTableView.getItems().addAll(PendingListForTable);
//        showAlert1("Refreshed", "All lists have been loaded.");
//    }
//}
...
//                    if (doc.isPaymentStatus() && "Verified".equals(doc.getPassportVerified())) {
//                        FileOutputStream fos = null;
//                        ObjectOutputStream oos = null;
//                        try{
